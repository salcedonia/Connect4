...
public class Board {
    ...
    public Position putToken(Token color, int column, int row)
	    throws InvalidMove {
	...
	return connectedLeftDiagonally(color)
		|| connectedRightDiagonally(color);
    }
